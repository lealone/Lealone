...
public class ErrorCode {
     ...
     * <pre>
     * Connection conn;
     * conn = DriverManager.getConnection(&quot;jdbc:yourbase:&tilde;/test&quot;);
     * conn = null;
     ...
     * <ul><li>In embedded mode (URL of the form jdbc:yourbase:~/test) if all
     * connections are opened within the same process and class loader.
     * </li><li>In server and cluster mode (URL of the form
     * jdbc:yourbase:tcp://localhost/test) using remote connections.
     * </li></ul>
     ...
     * Recovery tool (com.codefollower.yourbase.tools.Recover).
     */
     ...
     *      CALL "com.codefollower.yourbase.samples.TriggerSample$MyTrigger";
     * CREATE TRIGGER TRIGGER_A AFTER INSERT ON TEST
     *      CALL "com.codefollower.yourbase.samples.TriggerSample$MyTrigger";
     * </pre>
     */
     ...
     * Example of wrong usage:
     * <pre>
     * String url = &quot;jdbc:yourbase:&tilde;/test;CIPHER=AES&quot;;
     ...
     * Example:
     * <pre>
     * jdbc:yourbase:~/test;FILE_LOCK=LDAP
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:yourbase:~/test;LOCK_TIMEOUT=0;LOCK_TIMEOUT=1
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:yourbase:~/test;ACCESS_MODE_DATA=R
     * CREATE TABLE TEST(ID INT);
     * </pre>
     */
     ...
     * <pre>
     * jdbc:yourbase:&tilde;/test;DATABASE_EVENT_LISTENER='java.lang.String'
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:yourbase:~/test;UNKNOWN=TRUE
     * </pre>
     */
     ...
     * <pre>
     * java com.codefollower.yourbase.tools.Server -tcp -tcpAllowOthers
     * </pre>
     ...
     * yourbase.allowBigDecimalExtensions is not set. Using extensions of BigDecimal is
     ...
     * property yourbase.allowedClasses.
     */
     ...
     * Example of wrong usage:
     * <pre>
     * DriverManager.getConnection("jdbc:yourbase:~/t");
     * DriverManager.getConnection("jdbc:yourbase:~/test/");
     * </pre>
     * Correct:
     * <pre>
     * DriverManager.getConnection("jdbc:yourbase:~/te");
     * DriverManager.getConnection("jdbc:yourbase:~/test/te");
     * </pre>
     */

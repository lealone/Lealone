 ...
 */
package com.codefollower.yourbase.store.fs;
    ...
    private static void registerDefaultProviders() {
        if (providers == null || defaultProvider == null) {
            ...
            for (String c : new String[] {
                    "com.codefollower.yourbase.store.fs.FilePathDisk",
                    "com.codefollower.yourbase.store.fs.FilePathMem",
                    "com.codefollower.yourbase.store.fs.FilePathMemLZF",
                    "com.codefollower.yourbase.store.fs.FilePathSplit",
                    "com.codefollower.yourbase.store.fs.FilePathNio",
                    "com.codefollower.yourbase.store.fs.FilePathNioMapped",
                    "com.codefollower.yourbase.store.fs.FilePathZip"
            }) {
                try {

...
import com.lealone.server.http.protocol.http11.AbstractHttp11Protocol;
...
public class Http2Protocol implements UpgradeProtocol {
    ...
    @Override
    public Processor getProcessor(SocketWrapper<?> socketWrapper, Adapter adapter) {
    ...
    @Override
    public InternalHttpUpgradeHandler getInternalUpgradeHandler(SocketWrapper<?> socketWrapper,

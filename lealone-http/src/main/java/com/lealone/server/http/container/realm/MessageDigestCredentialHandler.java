    ...
    public void setEncoding(String encodingName) {
        if (encodingName == null) {
            ...
            try {
                ...
                log.error(sm.getString("mdCredentialHandler.unknownEncoding", encodingName,
                        encoding.name()));
            }
        }
    }
    ...
    public boolean matches(String inputCredentials, String storedCredentials) {
        ...
        if (getAlgorithm() == null) {
            ...
            if (storedCredentials.startsWith("{MD5}") || storedCredentials.startsWith("{SHA}")) {
                ...
                System.arraycopy(serverDigestPlusSaltBytes, digestLength, serverSaltBytes, 0,
                        saltLength);

...
public class JreMemoryLeakPreventionListener implements LifecycleListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(JreMemoryLeakPreventionListener.class);
    private static final StringManager sm = StringManager
            .getManager(JreMemoryLeakPreventionListener.class);
                ...
                if (classesToInitialize != null) {
                    ...
                    while (strTok.hasMoreTokens()) {
                        ...
                        try {
                            ...
                            log.error(sm.getString("jreLeakListener.classToInitializeFail",
                                    classNameToLoad), e);

...
import com.lealone.server.http.container.connector.ClientAbortException;
...
final class StandardHostValve extends ValveBase {
    ...
    public void invoke(Request request, Response response) throws IOException, ServletException {
        ...
        try {
            ...
            try {
                ...
                container.getLogger()
                        .error(sm.getString("standardHostValve.exception", request.getRequestURI()), t);
    ...
    private void status(Request request, Response response) {
        ...
        if (errorPage != null && response.isErrorReportRequired()) {
            ...
            setRequestErrorAttributes(request, statusCode, null, response.getMessage(), null,
            ...
            if (custom(request, response, errorPage)) {
                ...
                try {
                    ...
                    container.getLogger().warn(sm.getString("standardHostValve.exception", errorPage),
                            ioe);
                }
            }
        }
        ...
        if (errorPage != null) {
            if (response.setErrorReported()) {
                ...
                setRequestErrorAttributes(request, HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
                        realError.getClass(), throwable.getMessage(), realError,
                        errorPage.getLocation());
                ...
                if (custom(request, response, errorPage)) {
                    try {
                        ...
                        container.getLogger()
                                .warn(sm.getString("standardHostValve.exception", errorPage), ioe);
                    }
                }
            }
        } else {
    ...
    private void setRequestErrorAttributes(Request request, int statusCode, Class<?> exceptionType,
            String message, Throwable exception, String location) {
        /*
        ...
        try {
            ...
            if (rd == null) {
                container.getLogger().error(
                        sm.getString("standardHostValve.customStatusFailed", errorPage.getLocation()));
                return false;
            }

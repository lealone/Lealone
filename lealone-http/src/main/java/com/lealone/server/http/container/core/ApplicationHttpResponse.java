...
/**
 * Wrapper around a <code>com.lealone.server.servlet.http.HttpServletResponse</code> that transforms an application response object
 * (which might be the original one passed to a servlet, or might be based on the 2.3
 * <code>com.lealone.server.servlet.http.HttpServletResponseWrapper</code> class) back into an internal
 * <code>com.lealone.server.http.container.HttpResponse</code>.
 * <p>

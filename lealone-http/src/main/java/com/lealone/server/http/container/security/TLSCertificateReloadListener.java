...
public class TLSCertificateReloadListener implements LifecycleListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(TLSCertificateReloadListener.class);
                ...
                for (SSLHostConfig sslHostConfig : sslHostConfigs) {
                    if (!sslHostConfig.certificatesExpiringBefore(calendar.getTime()).isEmpty()) {
                        ...
                        try {
                            ...
                            // Now check again
                            Set<X509Certificate> expiringCertificates = sslHostConfig
                                    .certificatesExpiringBefore(calendar.getTime());

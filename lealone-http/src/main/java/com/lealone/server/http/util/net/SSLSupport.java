...
public interface SSLSupport {
     ...
     */
    String SECURE_PROTOCOL_KEY = "com.lealone.server.servlet.request.secure_protocol";

    /**
     * The Request attribute key for the cipher suite.
     */
    String CIPHER_SUITE_KEY = "com.lealone.server.servlet.request.cipher_suite";

    /**
     * The Request attribute key for the key size.
     */
    String KEY_SIZE_KEY = "com.lealone.server.servlet.request.key_size";

    /**
     * The Request attribute key for the client certificate chain.
     */
    String CERTIFICATE_KEY = "com.lealone.server.servlet.request.X509Certificate";

    /**
     * The Request attribute key for the session id. This one is a Tomcat extension to the Servlet spec.
     */
    String SESSION_ID_KEY = "com.lealone.server.servlet.request.ssl_session_id";

    /**
     * The request attribute key for the session manager. This one is a Tomcat extension to the Servlet spec.
     */
    String SESSION_MGR = "com.lealone.server.servlet.request.ssl_session_mgr";
     ...
     */
    @Deprecated
    String PROTOCOL_VERSION_KEY = "com.lealone.server.http.util.net.secure_protocol_version";

    /**
     * The request attribute key under which the String indicating the ciphers requested by the client are recorded.
     */
    String REQUESTED_CIPHERS_KEY = "com.lealone.server.http.util.net.secure_requested_ciphers";

    /**
     * The request attribute key under which the String indicating the protocols requested by the client are recorded.
     */
    String REQUESTED_PROTOCOL_VERSIONS_KEY = "com.lealone.server.http.util.net.secure_requested_protocol_versions";

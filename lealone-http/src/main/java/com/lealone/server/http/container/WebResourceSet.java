...
public interface WebResourceSet extends Lifecycle {
     ...
     *
     * @return <code>true</code> if these resources should only be used for class loader resource lookups, otherwise
     *             <code>false</code>
     */
     ...
     *
     * @return <code>true</code> if these resources should only be used for static (non-class loader) resource lookups,
     ...
     *
     * @param readOnly <code>true</code> if this set of resources should be configured to be read-only
     *
     ...
     *
     * @return <code>true</code> if this set of resources is configured to be read-only, otherwise <code>false</code>
     */
    boolean isReadOnly();

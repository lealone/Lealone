...
public interface ContextBind {
     ...
     * be made. If the class loader is changed and a {@link com.lealone.server.http.container.ThreadBindingListener} is configured
     * then {@link com.lealone.server.http.container.ThreadBindingListener#bind()} will be called after the change has been made.
     *
     ...
     * change will be made. If the class loader is changed and a {@link com.lealone.server.http.container.ThreadBindingListener} is
     * configured then {@link com.lealone.server.http.container.ThreadBindingListener#unbind()} will be called before the change is
     * made.
     *

...
import com.lealone.server.http.util.compat.JreVendor;
import com.lealone.server.http.util.net.SSLContext;
import com.lealone.server.http.util.net.SSLHostConfigCertificate;
import com.lealone.server.http.util.net.SSLUtilBase;
        ...
        if (!initialized) {
            synchronized (this) {
                if (!initialized) {
                    ...
                    String[] implementedProtocolsArray = context.getSupportedSSLParameters()
                            .getProtocols();
                    ...
                    String[] implementedCipherSuiteArray = context.getSupportedSSLParameters()
                            .getCipherSuites();

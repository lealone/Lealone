...
import com.lealone.server.http.util.file.ConfigurationSource.Resource;
...
public interface Context extends Container, ContextBind {
    ...
    /**
     * Notify all {@link com.lealone.server.servlet.ServletRequestListener}s that a request has started.
     *
    ...
    /**
     * Notify all {@link com.lealone.server.servlet.ServletRequestListener}s that a request has ended.
     *
     * @param request The request object that will be passed to the listener
     *
     * @return <code>true</code> if the listeners fire successfully, else <code>false</code>
     ...
     * {@link com.lealone.server.servlet.ServletRegistration.Dynamic}
     *
     ...
     * {@link com.lealone.server.servlet.http.HttpServletResponse#sendRedirect(String)} will use relative or absolute redirects.
     * <p>
     ...
     * {@link com.lealone.server.http.container.filters.RemoteIpFilter} if the filter is changing the scheme and/or port.
     *
     ...
     * {@link com.lealone.server.servlet.http.HttpServletResponse#sendRedirect(String)} use relative or absolute redirects.
     *
     ...
     * {@link com.lealone.server.servlet.http.HttpServletRequest#getContextPath()}, the return value is allowed to contain multiple
     * leading '/' characters.
     *
    ...
    /**
     * When returning a context path from {@link com.lealone.server.servlet.http.HttpServletRequest#getContextPath()}, is it
     ...
     * <code>com.lealone.server.http.container.STRICT_SERVLET_COMPLIANCE</code> is set to <code>true</code>, the default of this
     ...
     * provided path. If <code>com.lealone.server.http.container.STRICT_SERVLET_COMPLIANCE</code> is set to <code>true</code>, the

...
public interface UpgradeProtocol {
     ...
     */
    Processor getProcessor(SocketWrapper<?> socketWrapper, Adapter adapter);
     ...
     */
    InternalHttpUpgradeHandler getInternalUpgradeHandler(SocketWrapper<?> socketWrapper, Adapter adapter,
            Request request);

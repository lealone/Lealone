...
public interface Realm extends Contained {
     ...
     * @return the associated principal, or {@code null} if there is none.
     */
    Principal authenticate(String username, String digest, String nonce, String nc, String cnonce,
     ...
     */
    boolean hasResourcePermission(Request request, Response response, SecurityConstraint[] constraint,

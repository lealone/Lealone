...
import com.lealone.server.http.protocol.util.parser.MediaTypeCache;
import com.lealone.server.http.util.buf.CharChunk;
import com.lealone.server.http.util.buf.CharsetHolder;
import com.lealone.server.http.util.buf.UEncoder;
import com.lealone.server.http.util.buf.UriUtil;
import com.lealone.server.http.util.buf.UEncoder.SafeCharsSet;
...
public class Response implements HttpServletResponse {
     ...
     * Coyote response.
     */
    protected final com.lealone.server.http.protocol.Response coyoteResponse;
    ...
    public Response(com.lealone.server.http.protocol.Response coyoteResponse) {
        this(coyoteResponse, OutputBuffer.DEFAULT_BUFFER_SIZE);
    }

    public Response(com.lealone.server.http.protocol.Response coyoteResponse, int outputBufferSize) {
     ...
     */
    public com.lealone.server.http.protocol.Response getCoyoteResponse() {
    ...
    public String getCharacterEncoding() {
        ...
        if (charset == null) {
            charset = com.lealone.server.http.protocol.Constants.DEFAULT_BODY_CHARSET.name();
        }
    ...
    /**
     * An extended version of this exists in {@link com.lealone.server.http.protocol.Response}. This check is required here to ensure
     * that the usingWriter check in {@link #setContentType(String)} is applied since usingWriter is not visible to
     * {@link com.lealone.server.http.protocol.Response} Called from set/addHeader.
     *
    ...
    public void sendRedirect(String location, int status, boolean clearBuffer) throws IOException {
        ...
        try {
            ...
            // reference to com.lealone.server.http.container.STRICT_SERVLET_COMPLIANCE.
            String locationUri;

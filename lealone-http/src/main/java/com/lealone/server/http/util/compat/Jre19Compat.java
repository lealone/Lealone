 ...
 */
package com.lealone.server.http.util.compat;
...
public class Jre19Compat extends JreCompat {
    ...
    private static final Logger log = LoggerFactory.getLogger(Jre19Compat.class);
    ...
    @Override
    public Object getExecutor(Thread thread) throws NoSuchFieldException, SecurityException,
        ...
        if (result == null) {
            ...
            if (task != null && task.getClass().getCanonicalName() != null
                    && (task.getClass().getCanonicalName()
                            .equals("com.lealone.server.http.util.threads.ThreadPoolExecutor.Worker")
                            || task.getClass().getCanonicalName()

...
public class FormAuthenticator extends AuthenticatorBase {
    ...
    private final Logger log = LoggerFactory.getLogger(FormAuthenticator.class); // must not be static
    ...
    protected void register(Request request, HttpServletResponse response, Principal principal,
        ...
        super.register(request, response, principal, authType, username, password, alwaysUseSession,
                cache);

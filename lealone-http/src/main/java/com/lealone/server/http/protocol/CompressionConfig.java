...
import com.lealone.server.http.protocol.util.parser.AcceptEncoding;
import com.lealone.server.http.protocol.util.parser.TE;
...
public class CompressionConfig {
    ...
    private Set<String> noCompressionEncodings = new HashSet<>(
            Arrays.asList("br", "compress", "dcb", "dcz", "deflate", "gzip", "pack200-gzip", "zstd"));

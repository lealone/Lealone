...
public final class Constants {
     ...
     */
    public static final String SENDFILE_SUPPORTED_ATTR = "com.lealone.http.sendfile.support";
     ...
     * served.
     */
    public static final String SENDFILE_FILENAME_ATTR = "com.lealone.http.sendfile.filename";
     ...
     */
    public static final String SENDFILE_FILE_START_ATTR = "com.lealone.http.sendfile.start";
     ...
     */
    public static final String SENDFILE_FILE_END_ATTR = "com.lealone.http.sendfile.end";
     ...
     */
    public static final String REMOTE_ADDR_ATTRIBUTE = "com.lealone.http.remoteAddr";

    /**
     * The request attribute set by the RemoteIpFilter, RemoteIpValve (and may be set by other similar components) that
     * identifies for the connector the connection peer IP address.
     */
    public static final String PEER_ADDR_ATTRIBUTE = "com.lealone.http.peerAddr";
}

 ...
 * ({@link com.lealone.server.http.container.authenticator.SSLAuthenticator},
 * {@link com.lealone.server.http.container.authenticator.SpnegoAuthenticator}) that authenticate the user as well as obtain the user
 * credentials. An authenticated Principal is always created from the username presented to without further validation.
 * <p>

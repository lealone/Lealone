...
public abstract class AbstractProcessorLight implements Processor {
    ...
    private SocketState checkForPipelinedData(SocketState inState, SocketWrapper<?> socketWrapper)
            throws IOException {
     ...
     */
    protected void logAccess(SocketWrapper<?> socketWrapper) throws IOException {
        // NO-OP by default
    }

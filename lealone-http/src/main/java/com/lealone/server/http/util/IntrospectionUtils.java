 ...
 */
package com.lealone.server.http.util;
...
public final class IntrospectionUtils {
            ...
            for (Method item : methods) {
                ...
                if (setter.equals(item.getName()) && paramT.length == 1
                    ...
                    if (actualMethod != null) {
                        actualMethod.append(item.getName()).append("(\"").append(escape(value))
                                .append("\")");
                    }
                    return true;
                }
            ...
            for (Method method : methods) {
                ...
                if (setter.equals(method.getName()) && method.getParameterTypes().length == 1) {
                    ...
                    case "java.lang.Integer", "int" -> {
                        ...
                        if (actualMethod != null) {
                            if ("java.lang.Integer".equals(paramType.getName())) {
                                actualMethod.append(method.getName()).append("(Integer.valueOf(\"")
                                        .append(value).append("\"))");
                            } else {
                                actualMethod.append(method.getName()).append("(Integer.parseInt(\"")
                                        .append(value).append("\"))");
                            }
                        }
                        // Try a setFoo ( long )
                    ...
                    case "java.lang.Long", "long" -> {
                        ...
                        if (actualMethod != null) {
                            if ("java.lang.Long".equals(paramType.getName())) {
                                actualMethod.append(method.getName()).append("(Long.valueOf(\"")
                                        .append(value).append("\"))");
                            } else {
                                actualMethod.append(method.getName()).append("(Long.parseLong(\"")
                                        .append(value).append("\"))");
                            }
                        }
                    ...
                    case "java.lang.Boolean", "boolean" -> {
                        ...
                        if (actualMethod != null) {
                            if ("java.lang.Boolean".equals(paramType.getName())) {
                                actualMethod.append(method.getName()).append("(Boolean.valueOf(\"")
                                        .append(value).append("\"))");
                            } else {
                    ...
                    case "java.net.InetAddress" -> {
                        ...
                        if (actualMethod != null) {
                            actualMethod.append(method.getName()).append("(InetAddress.getByName(\"")
                                    .append(value).append("\"))");
                        }
                        // Unknown type
                    }
    ...
    public static Object callMethod1(Object target, String methodN, Object param1, String typeParam1,
    ...
    public static Object callMethodN(Object target, String methodN, Object[] params,

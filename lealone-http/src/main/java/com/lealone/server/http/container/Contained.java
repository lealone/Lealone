...
public interface Contained {
     ...
     *
     * @return The Container with which this instance is associated or <code>null</code> if not associated with a
     *             Container
     */
     ...
     *
     * @param container The Container instance with which this instance is to be associated, or <code>null</code> to
     *                      disassociate this instance from any Container
     */

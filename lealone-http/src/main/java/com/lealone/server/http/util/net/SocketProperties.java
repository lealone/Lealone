...
public class SocketProperties {
    ...
    private static final Logger log = LoggerFactory.getLogger(SocketProperties.class);
     ...
     * "https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/net/Socket.html#setPerformancePreferences(int,int,int)">setPerformancePreferences</a>
    ...
    public void setProperties(Socket socket) throws SocketException {
        ...
        if (performanceConnectionTime != null && performanceLatency != null
            ...
            socket.setPerformancePreferences(performanceConnectionTime.intValue(),
                    performanceLatency.intValue(), performanceBandwidth.intValue());
        }

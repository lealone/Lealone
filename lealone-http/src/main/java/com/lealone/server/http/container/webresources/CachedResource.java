...
public class CachedResource implements WebResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(CachedResource.class);
    ...
    public URL getURL() {
        ...
        try {
            CachedResourceURLStreamHandler handler = new CachedResourceURLStreamHandler(resourceURL,
        ...
        protected URLConnection openConnection(URL u) throws IOException {
            ...
            if (cacheURL != null && u == cacheURL) {
                if ("jar".equals(cacheURL.getProtocol())) {
                    return new CachedResourceJarURLConnection(resourceURL, root, webAppPath,
                            usesClassLoaderResources);
                } else {
                    return new CachedResourceURLConnection(resourceURL, root, webAppPath,
                            usesClassLoaderResources);
                }
            } else {

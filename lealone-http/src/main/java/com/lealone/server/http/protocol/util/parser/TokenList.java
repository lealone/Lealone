...
public class TokenList {
     ...
     */
    public static boolean parseTokenList(Enumeration<String> inputs, Collection<String> collection)
            throws IOException {
        boolean result = true;
     ...
     * @throws IOException If an I/O error occurs reading the header
     */
    public static boolean parseTokenList(Reader input, Collection<String> collection)
            throws IOException {

 ...
 */
package com.lealone.server.http.protocol.util.fileupload.disk;
...
import com.lealone.server.http.protocol.util.fileupload.DeferredFileOutputStream;
...
import com.lealone.server.http.protocol.util.fileupload.InvalidFileNameException;
import com.lealone.server.http.protocol.util.fileupload.ParameterParser;
import com.lealone.server.http.protocol.util.fileupload.util.Streams;

/**
 * The default implementation of the {@link com.lealone.server.http.protocol.util.fileupload.FileItem FileItem} interface.
 * <p>
 * After retrieving an instance of this class from a {@link DiskFileItemFactory} instance (see
 * {@link com.lealone.server.http.protocol.util.fileupload.FileUpload
 * #parseRequest(com.lealone.server.http.protocol.util.fileupload.RequestContext)}), you may either request all contents of file
...
public class DiskFileItem implements FileItem {
     ...
     *                                      exception and use
     *                                      {@link com.lealone.server.http.protocol.util.fileupload.InvalidFileNameException#getName()}.
     */
    @Override
    ...
    public String toString() {
        return String.format("name=%s, StoreLocation=%s, size=%s bytes, isFormField=%s, FieldName=%s",
                getName(), getStoreLocation(), Long.valueOf(getSize()), Boolean.valueOf(isFormField()),
                getFieldName());
    }

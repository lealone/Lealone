...
public class SpnegoAuthenticator extends AuthenticatorBase {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        if (krb5Conf == null) {
            ...
            File krb5ConfFile = new File(container.getBaseDir(), Constants.DEFAULT_KRB5_CONF);
        ...
        if (jaasConf == null) {
            // System property not set, use the Tomcat default
            File jaasConfFile = new File(container.getBaseDir(), Constants.DEFAULT_JAAS_CONF);

...
/**
 * Represents a {@link com.lealone.server.http.container.WebResourceSet} based on a single file.
 */
public class FileResourceSet extends AbstractFileResourceSet {
    ...
    /**
     * Creates a new {@link com.lealone.server.http.container.WebResourceSet} based on a file.
     *
    ...
    protected void checkType(File file) {
        if (!file.isFile()) {
            throw new IllegalArgumentException(sm.getString("fileResourceSet.notFile", getBase(),

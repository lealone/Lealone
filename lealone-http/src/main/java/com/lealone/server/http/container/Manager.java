...
public interface Manager {
     ...
     * implements {@link com.lealone.server.servlet.http.HttpSessionBindingListener}, should
     * {@link com.lealone.server.servlet.http.HttpSessionBindingListener#valueUnbound(com.lealone.server.servlet.http.HttpSessionBindingEvent)}
     * be called followed by
     * {@link com.lealone.server.servlet.http.HttpSessionBindingListener#valueBound(com.lealone.server.servlet.http.HttpSessionBindingEvent)}?
     * <p>
     ...
     * {@link com.lealone.server.servlet.http.HttpSessionBindingListener#valueBound(com.lealone.server.servlet.http.HttpSessionBindingEvent)}
     * when an attribute that is already present in the session is added again under the same name and the attribute
     * implements {@link com.lealone.server.servlet.http.HttpSessionBindingListener}.
     *
     ...
     * {@link com.lealone.server.servlet.http.HttpSessionAttributeListener} is configured for the session should
     * {@link com.lealone.server.servlet.http.HttpSessionAttributeListener#attributeReplaced(com.lealone.server.servlet.http.HttpSessionBindingEvent)}
     * be called?
     * <p>
     ...
     * {@link com.lealone.server.servlet.http.HttpSessionAttributeListener#attributeReplaced(com.lealone.server.servlet.http.HttpSessionBindingEvent)}
     * when an attribute that is already present in the session is added again under the same name and a
     * {@link com.lealone.server.servlet.http.HttpSessionAttributeListener} is configured for the session.
     *

...
public abstract class AbstractFileResourceSet extends AbstractResourceSet {
    ...
    private static final Logger log = LoggerFactory.getLogger(AbstractFileResourceSet.class);
    ...
    protected void logIgnoredSymlink(String contextPath, String absPath, String canPath) {
        ...
        if (absPath.startsWith("/META-INF/") || absPath.startsWith("/WEB-INF/")) {
            log.error(sm.getString("abstractFileResourceSet.canonicalfileCheckFailed", contextPath,
                    absPath, canPath));
        } else {
            log.warn(sm.getString("abstractFileResourceSet.canonicalfileCheckFailed", contextPath,
                    absPath, canPath));
        }
    }

...
public interface AccessLog {
     ...
     */
    String REMOTE_ADDR_ATTRIBUTE = "com.lealone.server.http.container.AccessLog.RemoteAddr";

    /**
     * Name of request attribute used to override remote host name recorded by the AccessLog.
     */
    String REMOTE_HOST_ATTRIBUTE = "com.lealone.server.http.container.AccessLog.RemoteHost";

    /**
     * Name of request attribute used to override the protocol recorded by the AccessLog.
     */
    String PROTOCOL_ATTRIBUTE = "com.lealone.server.http.container.AccessLog.Protocol";

    /**
     * Name of request attribute used to override the server name recorded by the AccessLog.
     */
    String SERVER_NAME_ATTRIBUTE = "com.lealone.server.http.container.AccessLog.ServerName";

    /**
     * Name of request attribute used to override the server port recorded by the AccessLog.
     */
    String SERVER_PORT_ATTRIBUTE = "com.lealone.server.http.container.AccessLog.ServerPort";
     ...
     * attributes used are:
     * <ul>
     * <li>com.lealone.server.http.container.RemoteAddr</li>
     * <li>com.lealone.server.http.container.RemoteHost</li>
     * <li>com.lealone.server.http.container.Protocol</li>
     * <li>com.lealone.server.http.container.ServerName</li>
     * <li>com.lealone.server.http.container.ServerPost</li>
     * </ul>
     *

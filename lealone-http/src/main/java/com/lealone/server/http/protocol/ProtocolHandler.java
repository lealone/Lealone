...
public interface ProtocolHandler {
     ...
     */
    static ProtocolHandler create(String protocol) throws ClassNotFoundException, InstantiationException,
            IllegalAccessException, IllegalArgumentException, InvocationTargetException,
            NoSuchMethodException, SecurityException {
        if (protocol == null || "HTTP/1.1".equals(protocol)
                || com.lealone.server.http.protocol.http11.Http11NioProtocol.class.getName()
                        .equals(protocol)) {
            return new com.lealone.server.http.protocol.http11.Http11NioProtocol();
        } else {

...
import com.lealone.server.http.protocol.util.fileupload.FileItemFactory;

/**
 * <p>The default {@link com.lealone.server.http.protocol.util.fileupload.FileItemFactory}
 * implementation. This implementation creates
 * {@link com.lealone.server.http.protocol.util.fileupload.FileItem} instances which keep
 * their
 ...
 * by the ServletContext attribute {@code com.lealone.server.servlet.context.tempdir}
 * may be used.
 * </p>
 *
...
public class DiskFileItemFactory implements FileItemFactory {
    ...
    public FileItem createItem(final String fieldName, final String contentType,
        ...
        final DiskFileItem result = new DiskFileItem(fieldName, contentType, isFormField, fileName,

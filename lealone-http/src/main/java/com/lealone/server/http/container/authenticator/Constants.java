...
public class Constants {
     ...
     * an RFC.
     */
    public static final String COOKIE_PARTITIONED_ATTR = com.lealone.server.http.util.descriptor.Constants.COOKIE_PARTITIONED_ATTR;
     ...
     */
    public static final String REQ_SSOID_NOTE = "com.lealone.server.http.container.request.SSOID";

    public static final String REQ_JASPIC_SUBJECT_NOTE = "com.lealone.server.http.container.authenticator.jaspic.SUBJECT";
     ...
     */
    public static final String SESSION_ID_NOTE = "com.lealone.server.http.container.authenticator.SESSION_ID";
     ...
     */
    public static final String SESS_PASSWORD_NOTE = "com.lealone.server.http.container.session.PASSWORD";
     ...
     * <code>Realm.authenticate()</code>.
     */
    public static final String SESS_USERNAME_NOTE = "com.lealone.server.http.container.session.USERNAME";
     ...
     */
    public static final String FORM_REQUEST_NOTE = "com.lealone.server.http.container.authenticator.REQUEST";
}

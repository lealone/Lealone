...
import com.lealone.server.http.container.util.CustomObjectInputStream;
import com.lealone.server.http.container.util.LifecycleBase;
    ...
    public void processExpires() {
        ...
        if (manager.getContext().getLogger().isTraceEnabled()) {
            manager.getContext().getLogger().trace(
                    getStoreName() + ": processExpires check number of " + keys.length + " sessions");
        }

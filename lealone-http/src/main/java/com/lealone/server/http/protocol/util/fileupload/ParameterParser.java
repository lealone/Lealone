...
import com.lealone.server.http.protocol.util.fileupload.util.mime.MimeUtility;
...
public class ParameterParser {
     ...
     * @return a map of name/value pairs
     */
    public Map<String, String> parse(final char[] charArray, final int offset, final int length,

...
import com.lealone.server.http.protocol.util.fileupload.MultipartStream.ItemInputStream;
import com.lealone.server.http.protocol.util.fileupload.util.Closeable;
...
public class FileItemStreamImpl implements FileItemStream {
     ...
     */
    public FileItemStreamImpl(final FileItemIteratorImpl pFileItemIterator, final String pName,
            final String pFieldName, final String pContentType, final boolean pFormField,

...
import com.lealone.server.http.container.util.Introspection;
import com.lealone.server.http.container.util.ServerInfo;
import com.lealone.server.http.container.util.URLEncoder;
import com.lealone.server.http.protocol.util.RequestUtil;
...
import com.lealone.server.servlet.ServletContextAttributeEvent;
...
import com.lealone.server.servlet.annotation.ServletSecurity;
...
public class ApplicationContext implements ServletContext {
    ...
    public RequestDispatcher getRequestDispatcher(final String path) {
        ...
        String uriToMap = com.lealone.server.http.container.util.RequestUtil.stripPathParams(uri, null);
        ...
        try {
            ...
            return new ApplicationDispatcher(wrapper, uri, wrapperPath, pathInfo, queryString, mapping,
                    null);
        } finally {
    ...
    public void setSessionTrackingModes(Set<SessionTrackingMode> sessionTrackingModes) {
        ...
        for (SessionTrackingMode sessionTrackingMode : sessionTrackingModes) {
            if (!supportedSessionTrackingModes.contains(sessionTrackingMode)) {
                throw new IllegalArgumentException(
                        sm.getString("applicationContext.setSessionTracking.iae.invalid",
    ...
    public void addListener(String className) {
        ...
        try {
            ...
            ExceptionUtils.handleThrowable(e.getCause());
            throw new IllegalArgumentException(
                    sm.getString("applicationContext.addListener.iae.cnfe", className), e);
        } catch (ReflectiveOperationException | NamingException e) {
            throw new IllegalArgumentException(
                    sm.getString("applicationContext.addListener.iae.cnfe", className), e);
        }
    ...
    public <T extends EventListener> void addListener(T t) {
        ...
        if (t instanceof ServletContextListener) {
            ...
            throw new IllegalArgumentException(sm
                    .getString("applicationContext.addListener.iae.wrongType", t.getClass().getName()));
        }
    }
    ...
    public <T extends EventListener> T createListener(Class<T> c) throws ServletException {
        try {
            ...
            throw new IllegalArgumentException(sm.getString(
                    "applicationContext.addListener.iae.wrongType", listener.getClass().getName()));
        } catch (InvocationTargetException e) {
            ExceptionUtils.handleThrowable(e.getCause());
            throw new ServletException(e);
        } catch (ReflectiveOperationException | NamingException e) {
    ...
    public void declareRoles(String... roleNames) {
        ...
        if (roleNames == null) {
            throw new IllegalArgumentException(
                    sm.getString("applicationContext.roles.iae", getContextPath()));
        }

        for (String role : roleNames) {
            if (role == null || role.isEmpty()) {
                throw new IllegalArgumentException(
                        sm.getString("applicationContext.role.iae", getContextPath()));
            }

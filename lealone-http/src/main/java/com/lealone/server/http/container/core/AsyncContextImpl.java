...
import com.lealone.server.http.protocol.AsyncContextCallback;
...
public class AsyncContextImpl implements AsyncContext, AsyncContextCallback {
    ...
    public void dispatch(ServletContext servletContext, String path) {
        synchronized (asyncContextLock) {
            ...
            this.dispatch = new AsyncRunnable(request, applicationDispatcher, servletRequest,
                    servletResponse);
    ...
    public <T extends AsyncListener> T createListener(Class<T> clazz) throws ServletException {
        ...
        T listener;
        try {
            listener = (T) context.getInstanceManager().newInstance(clazz.getName(),
        ...
        if (fireOnError) {
            ...
            for (AsyncListenerWrapper listener : listenersCopy) {
                try {
                    ...
                    log.warn(
                            sm.getString("asyncContextImpl.onErrorError", listener.getClass().getName()),
                            t2);
                } finally {
    ...
    private void logDebug(String method) {
        ...
        if (request == null) {
            ...
            com.lealone.server.http.protocol.Request coyoteRequest = request.getCoyoteRequest();
    ...
    private static class RunnableWrapper implements Runnable {
        ...
        private final com.lealone.server.http.protocol.Request coyoteRequest;

        RunnableWrapper(Runnable wrapped, Context ctxt,
                com.lealone.server.http.protocol.Request coyoteRequest) {
        ...
        public void run() {
            ...
            try {
                ...
                com.lealone.server.http.protocol.Response coyoteResponse = coyoteRequest.getResponse();
    ...
    private record AsyncRunnable(Request request, AsyncDispatcher applicationDispatcher,
            ServletRequest servletRequest, ServletResponse servletResponse) implements Runnable {

 ...
 */
package com.lealone.server.http.protocol.http11.upgrade;

import java.io.IOException;
import java.nio.ByteBuffer;

import com.lealone.server.http.protocol.AbstractProcessorLight;
...
public abstract class UpgradeProcessorBase extends AbstractProcessorLight implements WebConnection {
    ...
    @Override
    public final SocketState service(SocketWrapper<?> socketWrapper) throws IOException {
        return null;
    }

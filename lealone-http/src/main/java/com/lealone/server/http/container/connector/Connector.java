...
import com.lealone.server.http.protocol.AbstractProtocol;
import com.lealone.server.http.protocol.Adapter;
import com.lealone.server.http.protocol.ProtocolHandler;
...
import com.lealone.server.http.util.buf.CharsetUtil;
...
public class Connector extends LifecycleMBeanBase {
    ...
    public Connector(String protocol) {
        ...
        setThrowOnFailure(
                Boolean.getBoolean("com.lealone.server.http.container.startup.EXIT_ON_INIT_FAILURE"));
    }
    ...
    public void setURIEncoding(String URIEncoding) {
        try {
            ...
            log.error(sm.getString("coyoteConnector.invalidEncoding", URIEncoding, uriCharset.name()),
                    e);
        }
    }
     ...
     */
    public Request createRequest(com.lealone.server.http.protocol.Request coyoteRequest) {
     ...
     */
    public Response createResponse(com.lealone.server.http.protocol.Response coyoteResponse) {
    ...
    */
    ...
    protected void destroyInternal() throws LifecycleException {
        try {
            ...
            throw new LifecycleException(sm.getString("coyoteConnector.protocolHandlerDestroyFailed"),
                    e);
        }

...
public class InputBuffer extends Reader implements ByteChunk.ByteInputChannel, ApplicationBufferHandler {
     ...
     */
    public InputBuffer(com.lealone.server.http.protocol.Request coyoteRequest) {
     ...
     * @param coyoteRequest The associated Coyote request
     */
    public InputBuffer(int size, com.lealone.server.http.protocol.Request coyoteRequest) {
        this.size = size;

...
public final class FastHttpDateFormat {
    ...
    private static final int CACHE_SIZE = Integer
            .getInteger(FastHttpDateFormat.class.getName() + ".CACHE_SIZE", 1000).intValue();
     ...
     */
    private static final ConcurrentHashMap<Long, String> formatCache = new ConcurrentHashMap<>(
            CACHE_SIZE);

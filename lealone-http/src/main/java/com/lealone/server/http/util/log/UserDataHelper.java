 ...
 */
package com.lealone.server.http.util.log;
...
public class UserDataHelper {
    ...
    public UserDataHelper(Logger log) {
        ...
        Config tempConfig;
        String configString = System.getProperty(getClass().getName() + ".CONFIG");
        ...
        suppressionTime = Integer.getInteger(getClass().getName() + ".SUPPRESSION_TIME", 60 * 60 * 24)
                .intValue() * 1000L;

...
public enum ActionCode {
    ...
    /**
     * Callback for an async call to {@link com.lealone.server.servlet.AsyncContext#dispatch()}.
     */
    ASYNC_DISPATCH,
    ...
    /**
     * Callback for an async call to {@link com.lealone.server.servlet.AsyncContext#start(Runnable)}.
     */
    ASYNC_RUN,

    /**
     * Callback for an async call to {@link com.lealone.server.servlet.AsyncContext#complete()}.
     */
    ASYNC_COMPLETE,
    ...
    /**
     * Callback for an async call to {@link com.lealone.server.servlet.AsyncContext#setTimeout(long)}
     */
    ASYNC_SETTIMEOUT,

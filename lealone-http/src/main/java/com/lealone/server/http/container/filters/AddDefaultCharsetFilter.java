...
public class AddDefaultCharsetFilter extends FilterBase {
    ...
    private final Logger log = LoggerFactory.getLogger(AddDefaultCharsetFilter.class); // must not be static
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if (encoding == null || encoding.isEmpty() || encoding.equalsIgnoreCase("default")) {
            ...
            throw new IllegalArgumentException(
                    sm.getString("addDefaultCharset.unsupportedCharset", encoding));
        }
    }

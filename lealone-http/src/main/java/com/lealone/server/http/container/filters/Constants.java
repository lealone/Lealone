...
public final class Constants {
     ...
     */
    public static final String CSRF_NONCE_SESSION_ATTR_NAME = "com.lealone.server.http.container.filters.CSRF_NONCE";

    /**
     * The request attribute key under which the current request's CSRF nonce can be found.
     */
    public static final String CSRF_NONCE_REQUEST_ATTR_NAME = "com.lealone.server.http.container.filters.CSRF_REQUEST_NONCE";

    /**
     * The name of the request parameter which carries CSRF nonces from the client to the server for validation.
     */
    public static final String CSRF_NONCE_REQUEST_PARAM = "com.lealone.server.http.container.filters.CSRF_NONCE";

    /**
     * The servlet context attribute key under which the CSRF request parameter name can be found.
     */
    public static final String CSRF_NONCE_REQUEST_PARAM_NAME_KEY = "com.lealone.server.http.container.filters.CSRF_NONCE_PARAM_NAME";
     ...
     */
    public static final String CSRF_REST_NONCE_SESSION_ATTR_NAME = "com.lealone.server.http.container.filters.CSRF_REST_NONCE";

    /**
     * The servlet context attribute key under which the CSRF REST header name can be found.
     */
    public static final String CSRF_REST_NONCE_HEADER_NAME_KEY = "com.lealone.server.http.container.filters.CSRF_REST_NONCE_HEADER_NAME";
}

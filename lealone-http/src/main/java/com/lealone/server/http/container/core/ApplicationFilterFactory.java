...
public final class ApplicationFilterFactory {
    ...
    private static final Logger log = LoggerFactory.getLogger(ApplicationFilterFactory.class);
     ...
     */
    public static ApplicationFilterChain createFilterChain(ServletRequest request, Wrapper wrapper,
            Servlet servlet) {

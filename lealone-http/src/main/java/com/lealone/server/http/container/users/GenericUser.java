...
import com.lealone.server.http.container.UserDatabase;

/**
 * <p>
 * Concrete implementation of {@link com.lealone.server.http.container.User} for a {@link UserDatabase}.
 * </p>
 *
...
public class GenericUser<UD extends UserDatabase> extends AbstractUser {
     ...
     */
    GenericUser(UD database, String username, String password, String fullName, List<Group> groups,
            List<Role> roles) {

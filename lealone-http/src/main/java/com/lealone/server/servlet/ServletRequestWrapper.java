 ...
 *
 * @see com.lealone.server.servlet.ServletRequest
 *
 * @since Servlet 2.3
 */
public class ServletRequestWrapper implements ServletRequest {

    private static final StringManager sm = StringManager.getManager(ServletRequestWrapper.class);
    ...
    public ServletRequestWrapper(ServletRequest request) {
        if (request == null) {
            throw new IllegalArgumentException(sm.getString("wrapper.nullRequest"));
        }

...
public interface ServletContext {
     ...
     */
    String TEMPDIR = "com.lealone.server.servlet.context.tempdir";
     ...
     * @since Servlet 3.0
     */
    String ORDERED_LIBS = "com.lealone.server.servlet.context.orderedLibs";
     ...
     *                                           {@link com.lealone.server.servlet.annotation.WebListener}. For example, a
     ...
     *             {@link com.lealone.server.servlet.ServletRegistration.Dynamic} object that can be used to further configure the
     *             servlet
     *
     * @throws IllegalStateException         If the context has already been initialised
     * @throws UnsupportedOperationException If called from a
     ...
     *
     * @return a {@link com.lealone.server.servlet.ServletRegistration.Dynamic} object that can be used to further configure the
     *             servlet
     *
     * @since Servlet 4.0
     */
     ...
     *             {@link com.lealone.server.servlet.FilterRegistration.Dynamic} object that can be used to further configure the
     *             filter
     *
     * @throws UnsupportedOperationException If called from a
     *                                           {@link ServletContextListener#contextInitialized(ServletContextEvent)}
     ...
     *                                           {@link com.lealone.server.servlet.annotation.WebListener}
     *
     * @since Servlet 6.1
     */

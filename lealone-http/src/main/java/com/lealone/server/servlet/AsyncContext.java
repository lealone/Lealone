...
public interface AsyncContext {
     ...
     */
    String ASYNC_REQUEST_URI = "com.lealone.server.servlet.async.request_uri";

    /**
     * The attribute name for the Context Path of the async request
     */
    String ASYNC_CONTEXT_PATH = "com.lealone.server.servlet.async.context_path";

    /**
     * The attribute name for the Mapping of the async request
     */
    String ASYNC_MAPPING = "com.lealone.server.servlet.async.mapping";

    /**
     * The attribute name for the Path Info of the async request
     */
    String ASYNC_PATH_INFO = "com.lealone.server.servlet.async.path_info";

    /**
     * The attribute name for the Servlet Path of the async request
     */
    String ASYNC_SERVLET_PATH = "com.lealone.server.servlet.async.servlet_path";

    /**
     * The attribute name for the Query String of the async request
     */
    String ASYNC_QUERY_STRING = "com.lealone.server.servlet.async.query_string";
     ...
     *                                   {@link com.lealone.server.servlet.http.HttpServletRequest#startAsync()} or
     *                                   {@link com.lealone.server.servlet.http.HttpServletRequest#startAsync(ServletRequest, ServletResponse)}

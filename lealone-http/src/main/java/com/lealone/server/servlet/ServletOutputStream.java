...
public abstract class ServletOutputStream extends OutputStream {
    ...
    private static final StringManager sm = StringManager.getManager(ServletOutputStream.class);
    ...
    public void print(String s) throws IOException {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if ((c & 0xff00) != 0) { // high order byte must be zero
                String errMsg = sm.getString("err.not_iso8859_1");
    ...
    public void print(boolean b) throws IOException {
        String msg;
        if (b) {
            msg = sm.getString("value.true");
        } else {
            msg = sm.getString("value.false");
        }
        print(msg);
    }
    ...
    public void println(boolean b) throws IOException {
        StringBuilder sb = new StringBuilder();
        if (b) {
            sb.append(sm.getString("value.true"));
        } else {
            sb.append(sm.getString("value.false"));
        }
        sb.append("\r\n");
        print(sb.toString());
    }

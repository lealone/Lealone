...
/**
 * Equivalent of {@link com.lealone.server.servlet.annotation.HttpConstraint} for programmatic configuration of security
 * constraints.
 *
 * @since Servlet 3.0
 */
public class HttpConstraintElement {
    ...
    private static final StringManager sm = StringManager.getManager(HttpConstraintElement.class);
    ...
    public HttpConstraintElement(EmptyRoleSemantic emptyRoleSemantic,
        ...
        if (rolesAllowed != null && rolesAllowed.length > 0
            ...
            throw new IllegalArgumentException(sm.getString("httpConstraintElement.invalidRolesDeny"));
        }
        this.emptyRoleSemantic = emptyRoleSemantic;
        this.transportGuarantee = transportGuarantee;
        this.rolesAllowed = rolesAllowed;

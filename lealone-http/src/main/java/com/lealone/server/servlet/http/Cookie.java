...
public class Cookie implements Cloneable, Serializable {
    ...
    private static final StringManager sm = StringManager.getManager(Cookie.class);
    ...
    public void setAttribute(String name, String value) {
        if (name == null) {
            throw new IllegalArgumentException(sm.getString("cookie.attribute.invalidName.null"));
        }
        if (!validation.isToken(name)) {
            String msg = sm.getString("cookie.attribute.invalidName.notToken");
...
class CookieNameValidator {
    ...
    protected static final StringManager sm = StringManager.getManager(CookieNameValidator.class);
    ...
    void validate(String name) {
        if (name == null || name.isEmpty()) {
            throw new IllegalArgumentException(sm.getString("err.cookie_name_blank"));
        }
        if (!isToken(name)) {
            String errMsg = sm.getString("err.cookie_name_is_token");

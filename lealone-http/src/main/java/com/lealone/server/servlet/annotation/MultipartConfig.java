...
/**
 * This annotation is used to indicate that the {@link com.lealone.server.servlet.Servlet} on which it is declared expects requests
 * to be made using the {@code multipart/form-data} MIME type. <br>
 * <br>
 * {@link com.lealone.server.servlet.http.Part} components of a given {@code
 * multipart/form-data} request are retrieved by a Servlet annotated with {@code MultipartConfig} by calling
 * {@link com.lealone.server.servlet.http.HttpServletRequest#getPart} or
 * {@link com.lealone.server.servlet.http.HttpServletRequest#getParts}.<br>
 * <br>

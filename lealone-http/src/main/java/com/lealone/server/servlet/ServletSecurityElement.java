...
import com.lealone.server.servlet.annotation.HttpMethodConstraint;
import com.lealone.server.servlet.annotation.ServletSecurity;

/**
 * The programmatic equivalent of {@link com.lealone.server.servlet.annotation.ServletSecurity} used to configure security
...
public class ServletSecurityElement extends HttpConstraintElement {
    ...
    public ServletSecurityElement(HttpConstraintElement httpConstraintElement,
        ...
        super(httpConstraintElement.getEmptyRoleSemantic(),
                httpConstraintElement.getTransportGuarantee(), httpConstraintElement.getRolesAllowed());
        addHttpMethodConstraints(httpMethodConstraints);
    }
    ...
    public ServletSecurityElement(ServletSecurity annotation) {
        this(new HttpConstraintElement(annotation.value().value(),
                annotation.value().transportGuarantee(), annotation.value().rolesAllowed()));
            ...
            for (HttpMethodConstraint constraint : constraints) {
                HttpMethodConstraintElement e = new HttpMethodConstraintElement(constraint.value(),
                        new HttpConstraintElement(constraint.emptyRoleSemantic(),
                                constraint.transportGuarantee(), constraint.rolesAllowed()));
                l.add(e);
            }
        }

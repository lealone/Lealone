 ...
 */
package com.lealone.server.servlet.http;
...
import com.lealone.server.servlet.AsyncEvent;
import com.lealone.server.servlet.AsyncListener;
import com.lealone.server.servlet.DispatcherType;
import com.lealone.server.servlet.GenericServlet;
import com.lealone.server.servlet.ServletConfig;
...
public abstract class HttpServlet extends GenericServlet {
    ...
    private static final StringManager sm = StringManager.getManager(HttpServlet.class);

    private static final List<String> SENSITIVE_HTTP_HEADERS = Arrays.asList("authorization", "cookie",
            "x-forwarded", "forwarded", "proxy-authorization");
    ...
    public static final String LEGACY_DO_HEAD = "com.lealone.server.servlet.http.legacyDoHead";
     ...
     * <p>
     * Where possible, set the Content-Length header (with the {@link com.lealone.server.servlet.ServletResponse#setContentLength}
     ...
     *
     * @see com.lealone.server.servlet.ServletResponse#setContentType
     */
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        String msg = sm.getString("http.method_get_not_supported");
     ...
     *
     * @see com.lealone.server.servlet.ServletOutputStream
     * @see com.lealone.server.servlet.ServletResponse#setContentType
     *
     * @since Servlet 6.1
     */
    protected void doPatch(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        String msg = sm.getString("http.method_patch_not_supported");
        sendMethodNotAllowed(req, resp, msg);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        String msg = sm.getString("http.method_post_not_supported");
        sendMethodNotAllowed(req, resp, msg);
    }
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp)
        ...
        String msg = sm.getString("http.method_put_not_supported");
        sendMethodNotAllowed(req, resp, msg);
    }
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp)
        ...
        String msg = sm.getString("http.method_delete_not_supported");
        sendMethodNotAllowed(req, resp, msg);
    }
     ...
     * {@link com.lealone.server.servlet.Servlet#service} method. There's no need to override this method.
     *
     * @param req  the {@link HttpServletRequest} object that contains the request the client made of the servlet
     * @param resp the {@link HttpServletResponse} object that contains the response the servlet returns to the client
     *
     ...
     *
     * @see com.lealone.server.servlet.Servlet#service
     */
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        default -> {
            ...
            String errMsg = sm.getString("http.method_not_implemented");
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            throw new ServletException(sm.getString("http.non_http"));
        }
    ...
    private static class TomcatHack {
        ...
        static {
            ...
            Class<?> c1 = null;
            try {
                c1 = Class.forName("com.lealone.server.http.container.connector.RequestFacade");
    ...
    private static class NoBodyOutputStream extends ServletOutputStream {
        ...
        public void write(byte[] buf, int offset, int len) throws IOException {
            if (buf == null) {
                throw new NullPointerException(sm.getString("err.io.nullArray"));
            }

            if (offset < 0 || len < 0 || offset + len > buf.length) {
                String msg = sm.getString("err.io.indexOutOfBounds");
        ...
        private void resetBuffer() {
            if (flushed) {
                throw new IllegalStateException(sm.getString("err.state.commit"));
            }
            writtenByteCount = 0;
        }
    }

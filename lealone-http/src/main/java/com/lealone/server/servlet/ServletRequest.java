 ...
 * example, HTTP data is provided by {@link com.lealone.server.servlet.http.HttpServletRequest}).
 *
 * @see com.lealone.server.servlet.http.HttpServletRequest
 */
public interface ServletRequest {
     ...
     * <code>com.lealone.server.servlet.request.X509Certificate</code> can be used to retrieve information on the certificate of
     ...
     * {@link com.lealone.server.servlet.annotation.MultipartConfig} annotation or a <code>multipart-config</code> element in the

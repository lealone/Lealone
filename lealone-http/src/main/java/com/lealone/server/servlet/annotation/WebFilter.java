...
/**
 * The annotation used to declare a Servlet {@link com.lealone.server.servlet.Filter}. <br>
 * <br>
 * This annotation will be processed by the container during deployment, the Filter class in which it is found will be
 * created as per the configuration and applied to the URL patterns, {@link com.lealone.server.servlet.Servlet}s and
 * {@link com.lealone.server.servlet.DispatcherType}s.<br>
 * <br>
 ...
 * <br>
 * The annotated class MUST implement {@link com.lealone.server.servlet.Filter}. E.g. <code>@WebFilter("/path/*")</code><br>

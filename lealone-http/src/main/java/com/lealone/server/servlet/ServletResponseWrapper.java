 ...
 * @since Servlet 2.3
 *
 * @see com.lealone.server.servlet.ServletResponse
 */
public class ServletResponseWrapper implements ServletResponse {

    private static final StringManager sm = StringManager.getManager(ServletResponseWrapper.class);
    ...
    public ServletResponseWrapper(ServletResponse response) {
        if (response == null) {
            throw new IllegalArgumentException(sm.getString("wrapper.nullResponse"));
        }

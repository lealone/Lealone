...
public class HBaseCombinedResult extends CombinedResult {
    ...
    public HBaseCombinedResult(HBaseSession session, Query query, int maxrows) {
        ...
        if (!query.isDistributed()) {
            ...
            RowKeyConditionInfo rkci = (RowKeyConditionInfo) query.getConditionInfo();
    ...
    public HBaseCombinedResult(TableFilter filter) {
        ...
        RowKeyConditionInfo rkci = (RowKeyConditionInfo) filter.getSelect().getConditionInfo(filter);
        startKeys = rkci.getStartKeys();

...
public class Transaction extends TransactionBase {
    ...
    Transaction(Session session, DefaultTransactionEngine engine, int tid, int status, String name, long logId) {
        super(session);
     ...
     */
    public <K, V> DefaultTransactionMap<K, V> openMap(String name) {
     ...
     * @return the transaction map
     */
    public <K, V> DefaultTransactionMap<K, V> openMap(String name, DataType keyType, DataType valueType) {
        checkNotClosed();
        StorageMap<K, VersionedValue> map = transactionEngine.openMap(name, keyType, valueType);
        int mapId = map.getId();
        return new DefaultTransactionMap<K, V>(this, map, mapId);
    }
     ...
     */
    public <K, V> DefaultTransactionMap<K, V> openMap(StorageMap<K, VersionedValue> map) {
        checkNotClosed();
        int mapId = map.getId();
        return new DefaultTransactionMap<K, V>(this, map, mapId);
    }
     ...
     * @param map the map
     */
    public <K, V> void removeMap(DefaultTransactionMap<K, V> map) {

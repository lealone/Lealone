...
import com.codefollower.lealone.server.ShutdownHandler;
...
public class WebServer implements Service {
    ...
    private static final String[] GENERIC = {
        ...
        "Generic H2 (Server)|com.codefollower.lealone.Driver|jdbc:lealone:tcp://localhost/~/test|sa",
        // this will be listed on top for new installations
        "Generic H2 (Embedded)|com.codefollower.lealone.Driver|jdbc:lealone:~/test|sa",
    };
...
//                // "src/main/com/codefollower/lealone/server/web/res/_text_cs.prop"), -1);
//                "src/main/com/codefollower/lealone/res/_messages_cs.prop"), -1);
...
//    }
    ...
    byte[] getFile(String file) throws IOException {
        ...
        byte[] data = Utils.getResource("/com/codefollower/lealone/server/web/res/" + file);
        if (data == null) {
            trace(" null");
        } else {
...
//            }
    ...
    Connection getConnection(String driver, String databaseUrl, String user, String password) throws SQLException {
        ...
        if (databaseUrl.startsWith("jdbc:lealone:")) {
            if (ifExists) {
            ...
            return com.codefollower.lealone.Driver.load().connect(databaseUrl, p);
        }
//            try {

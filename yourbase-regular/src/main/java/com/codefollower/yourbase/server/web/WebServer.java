...
public class WebServer implements Service {
    ...
    private static final String[] GENERIC = {
        ...
        "Generic H2 (Server)|com.codefollower.yourbase.Driver|jdbc:yourbase:tcp://localhost/~/test|sa",
        // this will be listed on top for new installations
        "Generic H2 (Embedded)|com.codefollower.yourbase.Driver|jdbc:yourbase:~/test|sa",
    };
...
//                // "src/main/com/codefollower/yourbase/server/web/res/_text_cs.prop"), -1);
//                "src/main/com/codefollower/yourbase/res/_messages_cs.prop"), -1);
...
//    }
    ...
    byte[] getFile(String file) throws IOException {
        ...
        byte[] data = Utils.getResource("/com/codefollower/yourbase/server/web/res/" + file);
        if (data == null) {
            trace(" null");
        } else {
...
//            }
    ...
    Connection getConnection(String driver, String databaseUrl, String user, String password) throws SQLException {
        ...
        if (databaseUrl.startsWith("jdbc:yourbase:")) {
            if (ifExists) {
            ...
            return com.codefollower.yourbase.Driver.load().connect(databaseUrl, p);
        }
//            try {

...
<div id="toolCreateCluster" style="display: none">
    ...
    <table class="tool">
        <tr><td>
        ${text.tools.sourceDatabaseURL}:&nbsp;</td><td><input id="optionCreateCluster.0" name="urlSource" onkeyup="update()" onchange="update()" value="jdbc:yourbase:~/test" size="50" />
        </td></tr><tr><td>
        ${text.tools.targetDatabaseURL}:&nbsp;</td><td><input id="optionCreateCluster.1" name="urlTarget" onkeyup="update()" onchange="update()" value="jdbc:yourbase:~/copy/test" size="50" />
        </td></tr><tr><td>
...
<div id="commandLine" style="display: none">
        ...
        java -cp yourbase*.jar com.codefollower.yourbase.tools.<span id="toolName"></span>

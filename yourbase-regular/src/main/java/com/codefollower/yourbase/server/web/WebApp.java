 ...
 */
package com.codefollower.yourbase.server.web;
...
import com.codefollower.yourbase.tools.Backup;
import com.codefollower.yourbase.tools.ChangeFileEncryption;
import com.codefollower.yourbase.tools.ConvertTraceFile;
import com.codefollower.yourbase.tools.CreateCluster;
import com.codefollower.yourbase.tools.DeleteDbFiles;
import com.codefollower.yourbase.tools.Recover;
import com.codefollower.yourbase.tools.Restore;
import com.codefollower.yourbase.tools.RunScript;
import com.codefollower.yourbase.tools.Script;
...
import com.codefollower.yourbase.util.Profiler;
import com.codefollower.yourbase.util.ScriptReader;
...
public class WebApp {
        ...
        try {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"http://h2database.com/javadoc/com/codefollower/yourbase/constant/ErrorCode.html#c" + code
                            + "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("com.codefollower.yourbase.", idx);
                if (start < 0) {
    ...
    private String test() {
        ...
        boolean isH2 = url.startsWith("jdbc:yourbase:");
        try {

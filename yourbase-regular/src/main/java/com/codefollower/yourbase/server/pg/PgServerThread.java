 ...
 */
package com.codefollower.yourbase.server.pg;
...
import com.codefollower.yourbase.jdbc.JdbcPreparedStatement;
import com.codefollower.yourbase.jdbc.JdbcStatement;
    ...
    private void process() throws IOException {
        ...
        case 'p': {
            ...
            try {
                ...
                String url = "jdbc:yourbase:" + databaseName;
    ...
    private static void installPgCatalog(Statement stat) throws SQLException {
        ...
        try {
            r = new InputStreamReader(new ByteArrayInputStream(Utils
                    .getResource("/com/codefollower/yourbase/server/pg/pg_catalog.sql")));

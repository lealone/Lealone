 ...
 */
package com.codefollower.yourbase.bnf;
...
import com.codefollower.yourbase.server.web.DbContextRule;
...
public class Bnf {
    ...
    public static Bnf getInstance(Reader csv) throws SQLException, IOException {
        Bnf bnf = new Bnf();
        if (csv == null) {
            byte[] data = Utils.getResource("/com/codefollower/yourbase/res/help.csv");

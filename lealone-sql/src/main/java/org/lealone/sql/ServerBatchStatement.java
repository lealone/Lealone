...
public class ServerBatchStatement implements BatchStatement {
    ...
    public ServerBatchStatement(ServerSession session, ArrayList<String> batchCommands) {
        this.session = session;
        this.batchCommands = batchCommands;
    }

    public ServerBatchStatement(ServerSession session, StatementBase preparedCommand, ArrayList<Value[]> batchParameters) {
        this.session = session;

...
import com.codefollower.yourbase.mvstore.type.DataType;
...
import com.codefollower.yourbase.util.DateTimeUtils;
...
import com.codefollower.yourbase.value.ValueLob;
import com.codefollower.yourbase.value.ValueLobDb;
import com.codefollower.yourbase.value.ValueLong;
import com.codefollower.yourbase.value.ValueNull;
import com.codefollower.yourbase.value.ValueResultSet;
        ...
        case Value.RESULT_SET: {
            ...
            try {
                ...
                while (rs.next()) {
                    buff.put((byte) 1);
                    for (int i = 0; i < columnCount; i++) {
                        int t = com.codefollower.yourbase.value.DataType.convertSQLTypeToValueType(meta.getColumnType(i + 1));
                        Value val = com.codefollower.yourbase.value.DataType.readValue(null, rs, i + 1, t);

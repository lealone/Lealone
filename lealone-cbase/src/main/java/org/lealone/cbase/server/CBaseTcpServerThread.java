...
import org.lealone.cbase.engine.CBaseConnectionInfo;
import org.lealone.cbase.engine.CBaseDatabaseEngine;
import org.lealone.cbase.engine.CBaseSession;
...
public class CBaseTcpServerThread extends TcpServerThread {
    private final CBaseTcpServer server;

    protected CBaseTcpServerThread(Socket socket, CBaseTcpServer server, int threadId) {

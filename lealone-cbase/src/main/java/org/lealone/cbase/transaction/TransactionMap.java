...
import org.lealone.cbase.mvstore.Cursor;
...
public class TransactionMap<K, V> {
    ...
    TransactionMap(CBaseTransaction transaction, MVMap<K, VersionedValue> map, int mapId) {
     ...
     * @return the map
     */
    public TransactionMap<K, V> getInstance(CBaseTransaction transaction, long savepoint) {
    ...
    public CBaseTransaction getTransaction() {
        return transaction;
    }

...
public class DataType {
    ...
    static {
        ...
        add(Value.BYTE, Types.TINYINT, "Byte", createDecimal(ValueByte.PRECISION, ValueByte.PRECISION, 0,
                ValueByte.DISPLAY_SIZE, false, false), new String[] { "TINYINT" });
        add(Value.SHORT, Types.SMALLINT, "Short", createDecimal(ValueShort.PRECISION,
                ValueShort.PRECISION, 0, ValueShort.DISPLAY_SIZE, false, false),
        ...
        add(Value.UUID, Types.BINARY, "Bytes", createString(false), new String[] { "UUID" });
        ...
        dataType.prefix = "(";
        dataType.suffix = "')";
        add(Value.ARRAY, Types.ARRAY, "Array", dataType, new String[] { "ARRAY" });
        ...
        listType.prefix = "(";
        listType.suffix = "')";
        add(Value.LIST, Types.OTHER, "Object", listType, new String[] { "LIST" });

        DataType setType = new DataType();
        setType.prefix = "(";
        setType.suffix = "')";
        add(Value.SET, Types.OTHER, "Object", setType, new String[] { "SET" });

        DataType mapType = new DataType();
        mapType.prefix = "(";
        mapType.suffix = "')";
        add(Value.MAP, Types.OTHER, "Object", mapType, new String[] { "MAP" });

        DataType enumType = createString(false);
        enumType.supportsPrecision = false;
        // enumType.params = "ELEMENT [,...]";
        add(Value.ENUM, Types.OTHER, "Object", enumType, new String[] { "ENUM" });

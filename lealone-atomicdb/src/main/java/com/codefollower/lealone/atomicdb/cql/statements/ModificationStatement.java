...
import com.codefollower.lealone.atomicdb.db.marshal.BooleanType;
import com.codefollower.lealone.atomicdb.db.marshal.ListType;
...
public abstract class ModificationStatement implements CQLStatement, MeasurableForPreparedCache
{
    ...
    throws RequestExecutionException, RequestValidationException
    {
        ...
        OldThriftValidation.validateKey(cfm, key);
    ...
    public static abstract class Parsed extends CFStatement
    {
        ...
        {
            CFMetaData metadata = OldThriftValidation.validateColumnFamily(keyspace(), columnFamily());

 ...
 */
package com.codefollower.lealone.atomicdb.db.commitlog;
...
import com.codefollower.lealone.atomicdb.config.Config;
...
import com.codefollower.lealone.atomicdb.io.util.ByteBufferOutputStream;
import com.codefollower.lealone.atomicdb.io.util.ChecksummedOutputStream;
import com.codefollower.lealone.atomicdb.metrics.CommitLogMetrics;
import com.codefollower.lealone.atomicdb.net.MessagingService;
import com.codefollower.lealone.atomicdb.utils.PureJavaCrc32;
import com.google.common.util.concurrent.Futures;

import static com.codefollower.lealone.atomicdb.db.commitlog.CommitLogSegment.*;
...
public class CommitLog implements CommitLogMBean
{
    ...
    private CommitLog()
    {
        ...
        try
        {
            mbs.registerMBean(this, new ObjectName("com.codefollower.lealone.atomicdb.db:type=Commitlog"));
        }
        catch (Exception e)
        {

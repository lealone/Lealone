 ...
 * under the License.
 */
package com.codefollower.lealone.atomicdb.triggers;
...
import com.codefollower.lealone.atomicdb.config.TriggerDefinition;
import com.codefollower.lealone.atomicdb.db.ColumnFamily;
import com.codefollower.lealone.atomicdb.db.CounterMutation;
import com.codefollower.lealone.atomicdb.db.IMutation;
import com.codefollower.lealone.atomicdb.db.Mutation;
...
public class TriggerExecutor
{
    ...
    throws InvalidRequestException
    {
        ...
        {
            if (name.dataSize() > com.codefollower.lealone.atomicdb.db.Cell.MAX_NAME_LENGTH)
                throw new InvalidRequestException(String.format("column name is too long (%s > %s)",
                                                                name.dataSize(),
                                                                com.codefollower.lealone.atomicdb.db.Cell.MAX_NAME_LENGTH));
            if (name.isEmpty())

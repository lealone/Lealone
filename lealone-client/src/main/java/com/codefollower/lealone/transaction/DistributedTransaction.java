...
public class DistributedTransaction implements Transaction {
    private final Set<DistributedTransaction> children = New.hashSet();
    ...
    public Set<DistributedTransaction> getChildren() {
        return children;
    }

    public void addChildren(Set<DistributedTransaction> dts) {
        children.addAll(dts);
    }

    public void addChild(DistributedTransaction dt) {
        children.add(dt);
    }

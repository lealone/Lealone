 ...
 */
package org.lealone.client.jdbcx;
 ...
 *
 * <pre>
 * import org.lealone.jdbcx.JdbcDataSource;
 ...
 */
public class JdbcDataSource extends TraceObject implements XADataSource, DataSource, ConnectionPoolDataSource,
    ...
    static {
        org.lealone.client.jdbc.Driver.load();
    }

...
public class ZooKeeperAdmin {
    ...
    private static H2TcpPortTracker h2TcpPortTracker;
    ...
    private static Abortable newAbortable() {
    ...
    public static H2TcpPortTracker getH2TcpPortTracker() {
        if (h2TcpPortTracker == null) {
            synchronized (ZooKeeperAdmin.class) {
                if (h2TcpPortTracker == null) {
                    h2TcpPortTracker = new H2TcpPortTracker(getZooKeeperWatcher(), abortable);
                    try {

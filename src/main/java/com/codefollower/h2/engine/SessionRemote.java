...
import com.codefollower.h2.command.CommandRemote;
...
import com.codefollower.h2.value.Transfer;
    ...
    public SessionInterface connectEmbeddedOrServer(boolean openNew) {
        ...
        try {
            ...
            if (sessionFactory == null) {
                sessionFactory = (SessionFactory) Class.forName("com.codefollower.h2.engine.Engine").newInstance();
            }

 ...
 */
package com.codefollower.h2.server.web;
...
import com.codefollower.h2.bnf.Bnf;
...
import com.codefollower.h2.jdbc.JdbcSQLException;
import com.codefollower.h2.message.DbException;
import com.codefollower.h2.security.SHA256;
import com.codefollower.h2.tools.Backup;
import com.codefollower.h2.tools.ChangeFileEncryption;
import com.codefollower.h2.tools.ConvertTraceFile;
import com.codefollower.h2.tools.CreateCluster;
import com.codefollower.h2.tools.DeleteDbFiles;
import com.codefollower.h2.tools.Recover;
import com.codefollower.h2.tools.Restore;
import com.codefollower.h2.tools.RunScript;
import com.codefollower.h2.tools.Script;
...
import com.codefollower.h2.util.Profiler;
import com.codefollower.h2.util.ScriptReader;
import com.codefollower.h2.util.SortedProperties;
...
public class WebApp {
        ...
        try {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"http://h2database.com/javadoc/com/codefollower/h2/constant/ErrorCode.html#c" + code
                            + "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("com.codefollower.h2.", idx);
                if (start < 0) {

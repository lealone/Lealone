 ...
 */
package com.codefollower.h2.server.pg;
...
import com.codefollower.h2.jdbc.JdbcPreparedStatement;
import com.codefollower.h2.jdbc.JdbcStatement;
    ...
    private static void installPgCatalog(Statement stat) throws SQLException {
        ...
        try {
            r = new InputStreamReader(new ByteArrayInputStream(Utils
                    .getResource("/com/codefollower/h2/server/pg/pg_catalog.sql")));

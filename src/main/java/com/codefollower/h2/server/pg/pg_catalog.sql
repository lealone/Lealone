...
create alias pg_convertType deterministic for "com.codefollower.h2.server.pg.PgServer.convertType";

drop alias if exists pg_get_oid;
create alias pg_get_oid deterministic for "com.codefollower.h2.server.pg.PgServer.getOid";
...
create alias pg_get_indexdef for "com.codefollower.h2.server.pg.PgServer.getIndexColumn";

drop alias if exists version;
create alias version for "com.codefollower.h2.server.pg.PgServer.getVersion";

drop alias if exists current_schema;
create alias current_schema for "com.codefollower.h2.server.pg.PgServer.getCurrentSchema";

drop alias if exists pg_encoding_to_char;
create alias pg_encoding_to_char for "com.codefollower.h2.server.pg.PgServer.getEncodingName";

drop alias if exists pg_postmaster_start_time;
create alias pg_postmaster_start_time for "com.codefollower.h2.server.pg.PgServer.getStartTime";

drop alias if exists pg_get_userbyid;
create alias pg_get_userbyid for "com.codefollower.h2.server.pg.PgServer.getUserById";

drop alias if exists has_database_privilege;
create alias has_database_privilege for "com.codefollower.h2.server.pg.PgServer.hasDatabasePrivilege";

drop alias if exists has_table_privilege;
create alias has_table_privilege for "com.codefollower.h2.server.pg.PgServer.hasTablePrivilege";

drop alias if exists currtid2;
create alias currtid2 for "com.codefollower.h2.server.pg.PgServer.getCurrentTid";

 ...
 */
package com.codefollower.h2.store.fs;
    ...
    private static void registerDefaultProviders() {
        if (providers == null) {
            ...
            for (String c : new String[] {
                    "com.codefollower.h2.store.fs.FilePathMem",
                    "com.codefollower.h2.store.fs.FilePathMemLZF",
                    "com.codefollower.h2.store.fs.FilePathSplit",
                    "com.codefollower.h2.store.fs.FilePathNio",
                    "com.codefollower.h2.store.fs.FilePathNioMapped",
                    "com.codefollower.h2.store.fs.FilePathZip"
            }) {
                try {

...
public class HBaseJdbcResultSet extends JdbcResultSet implements ResultSet {
    ...
    HBaseJdbcResultSet(JdbcResultSet rs, JdbcConnection conn, JdbcStatement stat, String sql) {
        super(rs);
        this.rs = rs;
        this.conn = conn;
        this.stat = stat;
    ...
    HBaseJdbcResultSet(JdbcResultSet rs, JdbcConnection conn, JdbcPreparedStatement preparedStatement) {
        super(rs);
        this.rs = rs;
        this.conn = conn;
    ...
    public boolean next() throws SQLException {
        ...
        if (!next && conn.getRegionInfo() != null) {
            ...
            if (preparedStatement != null) {
                preparedStatement = preparedStatement.copy(newConn);

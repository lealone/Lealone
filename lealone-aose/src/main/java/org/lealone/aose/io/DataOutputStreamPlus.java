...
import org.lealone.aose.util.ByteBufferUtil;
...
public class DataOutputStreamPlus extends OutputStream implements DataOutputPlus {
    ...
    */
    ...
    private static int MAX_BUFFER_SIZE = Integer
            .parseInt(Config.getProperty("data_output_stream_plus_temp_buffer_size", "8192"));

...
public enum Permission {
    ...
    public static final Set<Permission> ALL_DATA = ImmutableSet.copyOf(EnumSet.range(Permission.CREATE, Permission.AUTHORIZE));

    public static final Set<Permission> ALL = ImmutableSet.copyOf(EnumSet.range(Permission.CREATE, Permission.AUTHORIZE));

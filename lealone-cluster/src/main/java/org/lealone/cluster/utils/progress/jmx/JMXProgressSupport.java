 ...
 */
package org.lealone.cluster.utils.progress.jmx;
...
import org.lealone.cluster.utils.progress.ProgressListener;
...
public class JMXProgressSupport implements ProgressListener {
    ...
    public void progress(String tag, ProgressEvent event) {
        Notification notification = new Notification("progress", tag, notificationSerialNumber.getAndIncrement(),

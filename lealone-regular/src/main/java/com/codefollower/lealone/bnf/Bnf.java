 ...
 */
package com.codefollower.lealone.bnf;
...
import com.codefollower.lealone.server.web.DbContextRule;
...
public class Bnf {
    ...
    public static Bnf getInstance(Reader csv) throws SQLException, IOException {
        Bnf bnf = new Bnf();
        if (csv == null) {
            byte[] data = Utils.getResource("/com/codefollower/lealone/res/help.csv");

...
-->
    ...
    &nbsp;&nbsp; <a href="help.jsp?jsessionid=${sessionId}">${text.a.help}</a>
        ...
        <div id="url" style="display: none">
            <h2>Lealone Database URLs</h2>
            <h3>Embedded</h3>
            <p>
            The URL <code>jdbc:lealone:~/test</code> means the database is stored in
            the user home directory in files starting with 'test'.
            Absolute locations like <code>jdbc:lealone:/data/db/test</code> are supported.
            ...
            <b>Warning</b>: if no path is used (for example jdbc:lealone:test),
            then the database is stored in the current working directory
            (the directory where the application was started).
            URLs of the form jdbc:lealone:data/test are relative to
            ...
            <p>
            The URL <code>jdbc:lealone:tcp://localhost/~/test</code> means connect
            over TCP/IP to the Lealone TCP server running on this computer, and open a database
            ...
            <h4>In-Memory</h4>
            <p>
            The URL <code>jdbc:lealone:mem:test</code> means open an in-memory database

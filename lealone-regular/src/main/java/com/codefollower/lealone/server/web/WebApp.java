 ...
 */
package com.codefollower.lealone.server.web;
...
import com.codefollower.lealone.bnf.Bnf;
...
import com.codefollower.lealone.tools.Backup;
import com.codefollower.lealone.tools.ChangeFileEncryption;
import com.codefollower.lealone.tools.ConvertTraceFile;
import com.codefollower.lealone.tools.CreateCluster;
import com.codefollower.lealone.tools.DeleteDbFiles;
import com.codefollower.lealone.tools.Recover;
import com.codefollower.lealone.tools.Restore;
import com.codefollower.lealone.tools.RunScript;
import com.codefollower.lealone.tools.Script;
import com.codefollower.lealone.tools.SimpleResultSet;
import com.codefollower.lealone.util.JdbcUtils;
import com.codefollower.lealone.util.New;
import com.codefollower.lealone.util.Profiler;
...
public class WebApp {
        ...
        try {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"http://h2database.com/javadoc/com/codefollower/lealone/constant/ErrorCode.html#c" + code
                            + "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("com.codefollower.lealone.", idx);
                if (start < 0) {
    ...
    private String test() {
        ...
        boolean isH2 = url.startsWith("jdbc:lealone:");
        try {

 ...
 */
package com.codefollower.lealone.tools;
...
//## AWT ##
    ...
    private boolean createTrayIcon() {
        try {
            ...
            if (d.width >= 24 && d.height >= 24) {
                iconFile = "/com/codefollower/lealone/res/h2-24.png";
                ...
                iconFile = "/com/codefollower/lealone/res/h2-64-t.png";
                // iconFile = "/com/codefollower/lealone/res/h2-22-t.png";
            } else {
                iconFile = "/com/codefollower/lealone/res/h2.png";
            }
    ...
    private void showWindow() {
        ...
        Image image = loadImage("/com/codefollower/lealone/res/h2.png");
        if (image != null) {

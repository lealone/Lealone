...
import com.codefollower.lealone.server.web.WebServer;
...
public class Server extends Tool implements Runnable, ShutdownHandler {
    ...
    public static void openBrowser(String url) throws Exception {
        try {
            ...
            String browser = Utils.getProperty(SysProperties.LEALONE_BROWSER, null);
            if (browser != null) {
            ...
            if (osName.indexOf("windows") >= 0) {
                ...
                if (!ok) {
                    ...
                    throw new Exception("Browser detection failed and system property " + SysProperties.LEALONE_BROWSER + " not set");
                }
            }
        } catch (Exception e) {

...
public class AOMapPerformanceTest extends StorageMapPerformanceTest {
    ...
    protected void openMap() {
        if (map == null || map.isClosed()) {
            map = storage.openAOMap(AOMapPerformanceTest.class.getSimpleName(), ValueInt.type, ValueString.type, null);
        }
    }

...
public class DateAndTimeFunctionTest extends TestBase {
    ...
    void test0() throws Exception {
        sql = "SELECT " //
                //以下这21个日期与时间函数在这个方法中: 
                //com.codefollower.lealone.expression.Function.getSimpleValue(Session, Value, Expression[], Value[])
                //----------------------------------------------------------------------------------------
                ...
                //以下这5个日期与时间函数在这个方法中: 
                //com.codefollower.lealone.expression.Function.getValueWithArgs(Session, Expression[])
                //----------------------------------------------------------------------------------------
                + "DATEADD('MONTH', 1, d), " //
    ...
    void test() throws Exception {
        //以下有21个日期与时间函数, 
        //在这个方法中com.codefollower.lealone.expression.Function.getSimpleValue(Session, Value, Expression[], Value[])
        //----------------------------------------------------------------------------------------
        ...
        //
        //以下有5个日期与时间函数, 
        //在这个方法中com.codefollower.lealone.expression.Function.getValueWithArgs(Session, Expression[])
        //----------------------------------------------------------------------------------------

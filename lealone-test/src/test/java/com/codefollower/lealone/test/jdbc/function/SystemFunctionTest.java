...
public class SystemFunctionTest extends TestBase {
    ...
    void test() throws Exception {
        ...
        //当成了com.codefollower.lealone.expression.Rownum，见com.codefollower.lealone.command.Parser.readTerm()
        sql = "SELECT ROWNUM()";
        //这样就没问题了,在这个方法中com.codefollower.lealone.command.Parser.readFunction(Schema, String)
        //把ROW_NUMBER转成com.codefollower.lealone.expression.Rownum了

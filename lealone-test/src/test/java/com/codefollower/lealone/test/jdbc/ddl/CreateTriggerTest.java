...
public class CreateTriggerTest extends TestBase {
    ...
    public static class MyTrigger implements Trigger {
        ...
        public void close() throws SQLException {
            System.out.println("com.codefollower.lealone.test.jdbc.ddl.CreateTriggerTest.MyInsertTrigger.close()");
        }

        @Override
        public void remove() throws SQLException {
            System.out.println("com.codefollower.lealone.test.jdbc.ddl.CreateTriggerTest.MyInsertTrigger.remove()");
        }

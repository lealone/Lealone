...
public class CreateViewTest extends TestBase {
    ...
    public void run0() throws Exception {
        ...
        //目前不支持参数:
        //com.codefollower.lealone.jdbc.JdbcSQLException: Feature not supported: "parameters in views"; SQL statement:
        ...
        //测试com.codefollower.lealone.command.Parser.parserWith()

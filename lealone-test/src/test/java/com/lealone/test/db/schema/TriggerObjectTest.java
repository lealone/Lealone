...
public class TriggerObjectTest extends DbObjectTestBase {
    ...
    public static class MyTrigger implements Trigger {
        ...
        public void close() throws SQLException {
            System.out.println("com.lealone.test.db.schema.TriggerObjectTest.MyInsertTrigger.close()");
        }

        @Override
        public void remove() throws SQLException {
            System.out.println("com.lealone.test.db.schema.TriggerObjectTest.MyInsertTrigger.remove()");
        }
    }
    ...
    void create() {
        ...
        try {
            ...
            executeUpdate("CREATE TRIGGER IF NOT EXISTS MyTrigger2"//
                    ...
                    + " QUEUE -1 CALL \"com.lealone.test.db.schema.TriggerObjectTest$MyTrigger\"");
            fail();
        } catch (Exception e) {

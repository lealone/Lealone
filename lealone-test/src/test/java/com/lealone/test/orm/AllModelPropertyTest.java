...
import com.lealone.test.orm.generated.AllModelProperty;
import com.lealone.test.service.generated.AllTypeService;
...
public class AllModelPropertyTest extends OrmTestBase {
    ...
    public static void insertLocal() {
        ...
        AllModelProperty all = create(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15,

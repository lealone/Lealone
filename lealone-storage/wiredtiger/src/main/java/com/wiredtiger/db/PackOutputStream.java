...
public class PackOutputStream {
     ...
     */
    public void addByte(byte value) throws WiredTigerPackingException {
     ...
     */
    public void addByteArray(byte[] value) throws WiredTigerPackingException {
     ...
     */
    public void addByteArray(byte[] value, int off, int len) throws WiredTigerPackingException {
     ...
     */
    public void addInt(int value) throws WiredTigerPackingException {
     ...
     */
    public void addLong(long value) throws WiredTigerPackingException {
     ...
     */
    public void addRecord(long value) throws WiredTigerPackingException {
     ...
     */
    public void addShort(short value) throws WiredTigerPackingException {
     ...
     */
    public void addString(String value) throws WiredTigerPackingException {
     ...
     */
    private void packLong(long x, boolean signed) throws WiredTigerPackingException {
        int offset = 0;
        ...
        if (x < PackUtil.NEG_2BYTE_MIN) {
            ...
            for (int shift = (len - 1) << 3; len != 0; shift -= 8, --len) {
                intBuf[offset++] = (byte) (x >> shift);
            }
        } else if (x < PackUtil.NEG_1BYTE_MIN) {
            x -= PackUtil.NEG_2BYTE_MIN;
            intBuf[offset++] = (byte) (PackUtil.NEG_2BYTE_MARKER | PackUtil.GET_BITS(x, 13, 8));
            intBuf[offset++] = PackUtil.GET_BITS(x, 8, 0);
        } else if (x < 0) {
            x -= PackUtil.NEG_1BYTE_MIN;
            intBuf[offset++] = (byte) (PackUtil.NEG_1BYTE_MARKER | PackUtil.GET_BITS(x, 6, 0));
        } else if (x <= PackUtil.POS_1BYTE_MAX) {
            intBuf[offset++] = (byte) (PackUtil.POS_1BYTE_MARKER | PackUtil.GET_BITS(x, 6, 0));
        } else if (x <= PackUtil.POS_2BYTE_MAX) {
            x -= PackUtil.POS_1BYTE_MAX + 1;
            intBuf[offset++] = (byte) (PackUtil.POS_2BYTE_MARKER | PackUtil.GET_BITS(x, 13, 8));
            intBuf[offset++] = PackUtil.GET_BITS(x, 8, 0);
        } else {
            ...
            for (int shift = (len - 1) << 3; len != 0; --len, shift -= 8) {
                intBuf[offset++] = (byte) (x >> shift);
            }
        }

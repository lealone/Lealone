...
public class SkipListSecondaryIndex extends BaseIndex {
    private final ConcurrentNavigableMap<Value, Row> rows = new ConcurrentSkipListMap<Value, Row>();
    private final int keyColumns;

    public SkipListSecondaryIndex(Table table, int id, String indexName, IndexColumn[] columns, IndexType indexType) {

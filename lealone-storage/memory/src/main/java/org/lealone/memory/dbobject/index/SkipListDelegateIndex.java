...
public class SkipListDelegateIndex extends BaseIndex {

    private final SkipListPrimaryIndex mainIndex;

    public SkipListDelegateIndex(SkipListTable table, int id, String name, IndexColumn[] cols, SkipListPrimaryIndex mainIndex,
            IndexType indexType) {
        if (id < 0)

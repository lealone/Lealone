 ...
 */
package org.lealone.memory.dbobject.table;
...
import org.lealone.memory.dbobject.index.SkipListDelegateIndex;
import org.lealone.memory.dbobject.index.SkipListPrimaryIndex;
import org.lealone.memory.dbobject.index.SkipListSecondaryIndex;
...
public class SkipListTable extends TableBase {
    private final SkipListPrimaryIndex primaryIndex;

    public SkipListTable(CreateTableData data) {
        super(data);
        ...
        primaryIndex = new SkipListPrimaryIndex(data.session.getDatabase(), this, getId(), IndexColumn.wrap(getColumns()),
    ...
    public Index addIndex(Session session, String indexName, int indexId, IndexColumn[] cols, IndexType indexType,
        ...
        if (isDelegateIndex)
            index = new SkipListDelegateIndex(this, indexId, indexName, cols, primaryIndex, indexType);
        else
            index = new SkipListSecondaryIndex(this, indexId, indexName, cols, indexType);

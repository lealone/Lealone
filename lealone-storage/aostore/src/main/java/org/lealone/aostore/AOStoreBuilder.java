 ...
 * @author zhh
 */
public class AOStoreBuilder {

    private final HashMap<String, Object> config = New.hashMap();

    private AOStoreBuilder set(String key, Object value) {
     ...
     * @return this
     */
    public AOStoreBuilder autoCommitDisabled() {
     ...
     * @return this
     */
    public AOStoreBuilder autoCommitBufferSize(int kb) {
     ...
     * @return this
     */
    public AOStoreBuilder autoCompactFillRate(int percent) {
     ...
     * @return this
     */
    public AOStoreBuilder storeName(String storeName) {
     ...
     * @return this
     */
    public AOStoreBuilder encryptionKey(char[] password) {
     ...
     * @return this
     */
    public AOStoreBuilder readOnly() {
     ...
     * @return this
     */
    public AOStoreBuilder inMemory() {
     ...
     * @return this
     */
    public AOStoreBuilder cacheSize(int mb) {
     ...
     * @return this
     */
    public AOStoreBuilder compress() {
     ...
     * @return this
     */
    public AOStoreBuilder compressHigh() {
     ...
     * @return this
     */
    public AOStoreBuilder pageSplitSize(int pageSplitSize) {
     ...
     * @return this
     */
    public AOStoreBuilder backgroundExceptionHandler(Thread.UncaughtExceptionHandler exceptionHandler) {
     ...
     * @return this
     */
    public AOStoreBuilder fileStore(FileStore store) {
     ...
     */
    public AOStoreBuilder retentionTime(int ms) {
     ...
     */
    public AOStoreBuilder versionsToKeep(int count) {
     ...
     */
    public AOStoreBuilder reuseSpace() {
     ...
     * @return the builder
     */
    public static AOStoreBuilder fromString(String s) {

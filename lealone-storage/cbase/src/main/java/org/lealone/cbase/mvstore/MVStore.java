 ...
 */
package org.lealone.cbase.mvstore;
...
import org.lealone.cbase.mvstore.Page.PageChildren;
import org.lealone.cbase.mvstore.cache.CacheLongKeyLIRS;
import org.lealone.cbase.mvstore.type.StringDataType;
...
public class MVStore {
    ...
    private final HashMap<String, Object> fileHeader = New.hashMap();
            ...
            while (it.hasNext()) {
                ...
                for (Chunk f : freed.values()) {
                    ...
                    if (c.pageCountLive < 0 && c.pageCountLive > -MARKED_FREE) {
                        throw DataUtils.newIllegalStateException(DataUtils.ERROR_INTERNAL, "Corrupt page count {0}",
                                c.pageCountLive);
                    }
    ...
    private void checkOpen() {
        if (closed) {
            throw DataUtils.newIllegalStateException(DataUtils.ERROR_CLOSED, "This store is closed");
        }
    }

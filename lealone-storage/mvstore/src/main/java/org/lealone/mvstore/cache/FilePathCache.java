 ...
 */
package org.lealone.mvstore.cache;
...
import org.lealone.storage.fs.FileBase;
import org.lealone.storage.fs.FilePathWrapper;
...
public class FilePathCache extends FilePathWrapper {
    ...
    public static class FileCache extends FileBase {
        ...
        // 1 MB cache size
        private final CacheLongKeyLIRS<ByteBuffer> cache = new CacheLongKeyLIRS<ByteBuffer>(1024 * 1024);

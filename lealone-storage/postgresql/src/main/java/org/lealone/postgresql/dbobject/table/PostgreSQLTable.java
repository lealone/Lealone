...
import org.lealone.postgresql.dbobject.index.PostgreSQLIndex;
...
public class PostgreSQLTable extends TableBase {
    ...
    public PostgreSQLTable(CreateTableData data) {
        ...
        indexes.add(new PostgreSQLIndex(this, getId(), IndexColumn.wrap(getColumns())));
    }

    @Override
    public Index addIndex(Session session, String indexName, int indexId, IndexColumn[] cols, IndexType indexType,
            boolean create, String indexComment) {
        Index index = new PostgreSQLIndex(this, indexId, cols);
        indexes.add(index);
        setModified();
        return index;
    }

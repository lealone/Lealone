...
import com.codefollower.yourbase.dbobject.constraint.ConstraintCheck;
import com.codefollower.yourbase.dbobject.constraint.ConstraintReferential;
import com.codefollower.yourbase.dbobject.constraint.ConstraintUnique;
...
public class MetaTable extends Table {
    ...
    public ArrayList<Row> generateRows(Session session, SearchRow first, SearchRow last) {
        ...
        case HELP: {
            String resource = "/com/codefollower/yourbase/res/help.csv";
            try {

...
public class JdbcDatabaseMetaData extends TraceObject implements DatabaseMetaData {
     ...
     *
     * @return false by default; true if the system property yourbase.sortNullsHigh is
     *         set to true
     */
     ...
     *
     * @return true by default; false if the system property yourbase.sortNullsHigh is
     *         set to true
     */

...
public class ConnectionInfo implements Cloneable {
     ...
     * Create a connection info object.
     *
     * @param u the database URL (must start with jdbc:yourbase:)
    ...
    public ConnectionInfo(String u, Properties info) {
        ...
        if (recoverTest != null) {
            ...
            try {
                Utils.callStaticMethod("com.codefollower.yourbase.store.RecoverTester.init", recoverTest);
            } catch (Exception e) {

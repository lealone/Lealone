...
public class Constants {
     ...
     * Only used if yourbase.lobInDatabase is enabled.
     */
     ...
     */
    public static final String SERVER_PROPERTIES_NAME = ".yourbase.server.properties";
     ...
     */
    public static final String START_URL = "jdbc:yourbase:";
     ...
     */
    public static final String SUFFIX_PAGE_FILE = ".yourbase.db";
     ...
     */
    public static final String USER_PACKAGE = "com.codefollower.yourbase.dynamic";

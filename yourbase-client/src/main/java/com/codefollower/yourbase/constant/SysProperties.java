...
public class SysProperties {
     ...
     * INTERNAL
     */
    public static final String YOURBASE_BROWSER = Constants.PROJECT_NAME_PREFIX + "browser";
     ...
     */
    public static final String BROWSER = getProperty(YOURBASE_BROWSER, null);
    ...
    /**
     * System property <code>prefix.temp.file</code> (default: yourbase.temp).<br />

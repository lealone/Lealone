...
public class CipherFactory {
    ...
    /**
     * The default password to use for the .yourbase.keystore file
     */
    public static final String KEYSTORE_PASSWORD = "h2pass";

    private static final String KEYSTORE = "~/.yourbase.keystore";
...
/**
    ...
    public static KeyStore getKeyStore(String password) throws IOException {
        try {
            ...
            store.setKeyEntry("yourbase", privateKey, password.toCharArray(), certs);
            // --- generated code end ---
            return store;
        } catch (Exception e) {
            throw DbException.convertToIOException(e);

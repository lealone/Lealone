 ...
 */
package com.codefollower.yourbase.test.jdbc.embedded;
...
public class EmbeddedRegularDatabaseTest extends TestBase {
    ...
    public static void setUpBeforeClass() throws Exception {
        System.setProperty("yourbase.base.dir", HBaseUtils.getConfiguration().get("yourbase.test.dir"));
    ...
    public void run() throws Exception {
        String tableName = "EmbeddedRegularDatabaseTest";

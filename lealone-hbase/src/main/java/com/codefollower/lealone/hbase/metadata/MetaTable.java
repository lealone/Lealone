...
import com.codefollower.lealone.hbase.zookeeper.MetaTableTracker;
...
public class MetaTable {
    ...
    public MetaTable(HBaseDatabase database) throws Exception {
        ...
        maxRedoRecords = HBaseUtils.getConfiguration().getInt("lealone.max.redo.records", DEFAULT_MAX_REDO_RECORDS);

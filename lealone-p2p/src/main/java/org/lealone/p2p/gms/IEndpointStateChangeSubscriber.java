...
public interface IEndpointStateChangeSubscriber {
     ...
     */
    public default void onJoin(NetEndpoint endpoint, EndpointState epState) {
    }

    public default void beforeChange(NetEndpoint endpoint, EndpointState currentState, ApplicationState newStateKey,
            VersionedValue newValue) {
    }

    public default void onChange(NetEndpoint endpoint, ApplicationState state, VersionedValue value) {
    }

    public default void onAlive(NetEndpoint endpoint, EndpointState state) {
    }

    public default void onDead(NetEndpoint endpoint, EndpointState state) {
    }

    public default void onRemove(NetEndpoint endpoint) {
    }
     ...
     */
    public default void onRestart(NetEndpoint endpoint, EndpointState state) {
    }
}
